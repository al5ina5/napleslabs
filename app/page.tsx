  ...
  return (
    <div className="py-12 lg:py-24 space-y-24 lg:space-y-48">
      ...
      <div className="max-w-5xl w-full mx-auto px-12 lg:px-24 space-y-12">
        ...
        <p className="text-2xl lg:text-4xl font-charon"><a href="https://sebastianalsina.com" className="underline hover:no-underline">Sebastian Alsina</a> is a profressional software engineer who has been tinkering with computers for over 10 years.
        </p>
        ...
        <div className="space-y-4">
          <div className="font-charon flex gap-6">
            ...
            <p className="text-2xl"><b>No upgrade or fix, no charge.</b> If we can't upgrade your machine, you don't pay. No questions asked.</p>
          </div>
          <div className="font-charon flex gap-6">
            <Check className="w-8 h-8 shrink-0" />
            <p className="text-2xl"><b>Upfront pricing:</b> you'll know the cost before we do anything — no surprises.</p>
          </div>
          <div className="font-charon flex gap-6">
            <Check className="w-8 h-8 shrink-0" />
          ...
          <div className="font-charon flex gap-6">
            <Check className="w-8 h-8 shrink-0" />
            <p className="text-2xl"><b>Data integirty matters to us.</b> We take care when handling your files and always prioritize keeping your data intact and private.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative max-w-7xl w-full mx-auto text-white">
        <img className="w-full" src="/img/working.png" alt="" />
